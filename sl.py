...
import numpy as np # conda update numpy
import pandas as pd # needed - conda install openpyxl, this then threw: InconsistentVersionWarning: Trying to unpickle estimator LinearRegression from version
...
# Sidebar setup
# image_sidebar = Image.open('car.png')  # Replace with your image file
...
def get_user_input():
    ...
    # Top banner
#image_banner = Image.open('car.png')  # Replace with your image file
